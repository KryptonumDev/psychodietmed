    ...
    const handleScrollCountup = () => {
      counters.forEach((counter) => {
        ...
        if (
          ...
          counter.classList.contains("counter") &&
    ...
    <section className={styles.wrapper}>
      <div className={styles.grid}>
        <div>
          ...
          />
          <p
            className={styles.pinkListTitle}
            dangerouslySetInnerHTML={{ __html: pinkList.title }}
          />
      ...
      <div className={styles.cta}>
        <p
          className={styles.blueListTitle}
          dangerouslySetInnerHTML={{ __html: blueList.title }}
        />
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: textBot }}
        />
      </div>
    </section>
  );
