...
export default function Citate({ data }) {
  ...
  return (
    ...
    <Image quality={100} aspectRatio={true} className={styles.image} src={image.mediaItemUrl} alt={image.altText} width={image.mediaDetails.width} height={image.mediaDetails.height} />
