...
export default async function Post({ params }) {
  const { data, posts, specialists } = await getData(params);
  ...
  return (
    <main id="main">
      <script key={`article`} type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} />
      <Breadcrumbs
        data={[
          { page: 'Blog', url: `/blog` },
          { page: data.title, url: `/blog/${params.post_slug}` },
        ]}
      />
      <Hero data={data} />
      <Content
